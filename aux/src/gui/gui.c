...
int gui_runner()
{
...
#endif
    win = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "AUX GUI", NULL, NULL);
    if (!win)
    {
    ...
    struct nk_font *font = nk_font_atlas_add_default(atlas, 13, NULL); // Carregar uma fonte padrão
